...
def main(train_filename, min_count=10, percent=1.0, id2word_name='id2word_'):
    # Preprocess all texts
    all_text = preprocessAll(train_filename, percent)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id2word_name', type=str, default="id2word_")
    ...
    id2word_name = args.id2word_name

    if not os.path.exists(os.path.join("output/", str(min_count))):
        os.makedirs(os.path.join("output/", str(min_count)))

    main(train_filename=filename, min_count=min_count, percent=percent, id2word_name=id2word_name)
